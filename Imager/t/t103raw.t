...
binmode FH;
i_writeraw($palim, fileno(FH)) or print "not ";
print "ok 8\n";
close FH;
...
binmode FH;
i_writeraw($img16, fileno(FH)) or print "not ";
print "ok 11\n";
close FH;
...
binmode FH;
i_writeraw($maskimg, fileno(FH)) or print "not ";
print "ok 13\n";
close FH;
...
binmode FH;
my $cmpimgmask = i_readraw(fileno(FH), 150, 150, 3, 3, 0)
  or print "not ";
print "ok 14\n";
